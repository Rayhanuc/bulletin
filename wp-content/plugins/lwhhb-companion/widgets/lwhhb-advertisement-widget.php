...
// Adds widget: lwhhb Advertisement
class Lwhhbadvertisement_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'lwhhbadvertisement_widget',
			esc_html__( 'Bulletin Advertisement', 'lwhhb' )
		);
	...
	public function widget( $args, $instance ) {
		...
		$media = wp_get_attachment_image_src($instance['lwhhb_adv_img'],'full');

		echo '<a href="'.esc_url($instance['lwhhb_adv_url']).'"><img class="img-fluid" src="'.esc_url($media[0]).'" alt=""/></a>';
...
function register_lwhhbadvertisement_widget() {
	register_widget( 'lwhhbadvertisement_Widget' );
}

add_action( 'widgets_init', 'register_lwhhbadvertisement_widget' );