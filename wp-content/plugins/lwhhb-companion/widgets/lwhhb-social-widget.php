...
class LwhhbSocialIcons_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'lwhhb_social_icons', // Base ID
			__( 'Bulletin Social Icons', 'lwhhb-companion' ), // Name
			array( 'description' => __( 'Social Icons', 'lwhhb-companion' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		?>
		<div class="<?php echo esc_attr( $instance['classname'] ); ?> widget-social">
			<?php
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'lwhhb-companion' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"
			       name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text"
			       value="<?php echo esc_attr( $title ); ?>"/>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'classname' ) ); ?>"><?php _e( 'CSS Class name:', 'lwhhb-companion' ); ?></label>
		...
		<?php foreach ( $social_icons as $sci ) {
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( $sci ) ); ?>"><?php echo esc_html( ucfirst( $sci ) . " " . __( 'URL', 'lwhhb-companion' ) ); ?>
					: </label>
				<br/>
...
function lwhhbc_social_icons_widget() {
	register_widget( 'lwhhbSocialIcons_Widget' );
}

add_action( 'widgets_init', 'lwhhbc_social_icons_widget' );
